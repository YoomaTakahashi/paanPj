<template>
    ...
    <v-app>
        ...
        <ClientOnly>
            <v-navigation-drawer v-model="drawer" width="260" app color="#404040" :temporary="isMobile"
                :permanent="!isMobile">
...
const logout = () => {
    if (!confirm('ท่านต้องการออกระบบใช่หรือไม่')) return
...
const roles = [
    ...
    { title: 'ดำเนินการประเมิน', to: '/Committee/show_eve', role: 'กรรมการประเมิน' },
    { title: 'ตรวจสอบผลและยืนยันผล', to: '/Committee/check_comfirm', role: 'กรรมการประเมิน' },
